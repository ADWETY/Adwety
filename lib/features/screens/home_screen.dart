...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final AsyncValue<List<Pharmacy>> trustedPharmacies = ref.watch(
      trustedPharmaciesProvider,
    );
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 24.h),
            Text('Nearby Pharmacies', style: AppTextStyles.h3),
            SizedBox(height: 14.h),
            trustedPharmacies.when(
              data: (List<Pharmacy> pharmacies) {
                final List<Pharmacy> sortedPharmacies =
                    List<Pharmacy>.from(pharmacies)..sort(
                      (Pharmacy a, Pharmacy b) =>
                          a.distanceKm.compareTo(b.distanceKm),
                    );

                return Column(
                  children: sortedPharmacies
                      .map(
