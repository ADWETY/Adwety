...
// Shared retail API is now available to pharmacists only.
// Administrator retail/MATGR pages were removed from the dashboard scope.
router.use('/retail', auth, auth.authorize(['pharmacist']), retailRoutes);
