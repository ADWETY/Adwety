...
export default function RoleBadge({ role }) {
  ...
  const labels = language === 'ar'
    ? { super_admin: 'مدير عام', pharmacy_admin: 'مدير صيدلية', support_admin: 'دعم فني', user: 'مستخدم' }
    : { super_admin: 'Super Admin', pharmacy_admin: 'Pharmacy Admin', support_admin: 'Support Admin', user: 'User' };
  return (
