...
export default function RoleBadge({ role }) {
  ...
  const labels = language === 'ar'
    ? { owner: 'المالك', super_admin: 'مدير عام', admin: 'مدير', pharmacy_admin: 'مدير صيدلية', support_admin: 'دعم فني', user: 'مستخدم' }
    : { owner: 'Owner', super_admin: 'Super Admin', admin: 'Admin', pharmacy_admin: 'Pharmacy Admin', support_admin: 'Support Admin', user: 'User' };
  return (
