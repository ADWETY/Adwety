...
import { CategoriesPage, InvoicesPage, InventoryCountPage, PosPage, ProductsCatalogPage, PurchasesPage, ReportsPage, RetailDashboardPage, ReturnsPage, SuppliersPage, TreasuryPage } from './pages/retail/RetailPages';
    ...
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route element={<ProtectedRoute roles={retailRoles}><RetailWorkspaceRoute /></ProtectedRoute>}>
          ...
          <Route path="warehouses" element={<Navigate to="/retail-dashboard" replace />} />
          <Route path="customers" element={<Navigate to="/retail-dashboard" replace />} />
          <Route path="suppliers" element={<SuppliersPage />} />
          <Route path="pos" element={<PosPage />} />
          <Route path="purchases" element={<PurchasesPage />} />
          <Route path="sales-invoices" element={<InvoicesPage />} />
          <Route path="returns" element={<ReturnsPage />} />
          <Route path="transfers" element={<Navigate to="/retail-dashboard" replace />} />
        ...
        <Route path="medicines/new" element={<ProtectedRoute roles={ROLE_GROUPS.hidden}><AddMedicinePage /></ProtectedRoute>} />
        ...
        <Route path="pharmacy-requests" element={<ProtectedRoute roles={ROLE_GROUPS.hidden}><PharmacyRequestsPage /></ProtectedRoute>} />
