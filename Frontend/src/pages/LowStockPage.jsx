...
export default function LowStockPage() {
  ...
  useEffect(() => { async function load() { try { const [result, pharmacyResult] = await Promise.all([getJson('/medicines'), getJson('/pharmacies')]); setRows(extractArray(result)); setPharmacies(extractArray(pharmacyResult)); setError(''); } catch (loadError) { setRows([]); setPharmacies([]); setError(loadError.message || t('toast.failed')); } } load(); }, [t]);
