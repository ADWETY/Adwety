...
export default function PharmacyDetailsPage() {
  ...
  useEffect(() => { async function load() { try { const result = await getJson(`/pharmacies/${id}`); setDetails(extractPharmacyDetails(result, getDemoPharmacyDetails(id))); } catch (_error) { setDetails(getDemoPharmacyDetails(id)); } finally { setLoading(false); } } load(); }, [id]);
