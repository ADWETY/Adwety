...
export default function NotificationsPage() {
  ...
  useEffect(() => { async function load() { try { const result = await getJson('/notifications'); setRows(result.data || demoNotifications); } catch (_error) { setRows(demoNotifications); } } load(); }, []);
